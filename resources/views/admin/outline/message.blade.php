@extends('admin.public.index')
	...
	@section('content')
        ...
        <div class="page-container">
            ...
            {{--</div>--}}
            <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="removeIframe()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 一键清除所有消息</a></span> </div>
            <div class="mt-20">
                <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
                    ...
                    <tr class="text-c">
                        ...
                        <td class="f-14 td-manage">
                            <a style="text-decoration:none" class="ml-5" onClick="book_del(this,'{{ $key }}')" href="javascript:;" title="清空"><i class="Hui-iconfont">&#xe6e2;</i></a>
                        </td>
                    </tr>
                    @endforeach
                    </tbody>
    ...
    @section('script')
        ...
        <script type="text/javascript">
            ...
            function book_del(obj,id){
                $.ajax({
                    type: 'get',
                    url: '{{ url('admin/outline_delete_message') }}'+'/'+id,
                    dataType: 'json',
