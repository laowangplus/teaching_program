@extends('admin.public.index')
	...
	@section('content')
        <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 教学大纲管理 <span class="c-gray en">&gt;</span> 审核管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
            ...
            <div class="mt-20">
                <table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
                    ...
                    <tr class="text-c">
                        ...
                        @if($course->examine_type == 0)
                            <td>未通过</td>
                        @elseif(($course->examine_type > 0))
                            <td>已通过</td>
                        @endif
                        @if($course->type == 0)
                            <td>未通过</td>
                        ...
                        <td class="f-14 td-manage">
                            ...
                            <a style="text-decoration:none" class="ml-5" onClick="borrow('审核','{{ url('/admin/outline_audit_check/'.$course->id) }}','4','','510')" href="javascript:;" title="审核"><i class="Hui-iconfont">&#xe63c;</i></a>
